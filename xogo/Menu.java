    ...
    public Menu() {
        ...
        while (!sair) {
            ...
            switch (comando0) {
                ...
                case "edificar":
                    if (avatar.getPosicion().getTipo().equals("Solar")) {
                        if (avatar.getPosicion().getDono().getNome().equals(xogador.getNome())) {
                            switch (comando1) {
                                case "casa":
                                    //System.out.println(taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getCasas());
                                    //System.out.println(taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getHoteis());
                                    if (taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getCasas() < 4)//Comprobamos que non quera construir máis casas que o MAX
                                    {
                                        //  System.out.println(taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getMaxconstrucions());
                                        if ((taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getMaxconstrucions() > taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getHoteis()) || (taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getMaxconstrucions() > taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getCasas()))//Comprobamos que se xa ten o máximo de hoteis e casas non poda construir máis casas
                                        {
                                            if (xogador.getAvatar().getPosicion().getGrupo().getCasas() < xogador.getAvatar().getPosicion().getGrupo().getMaxconstrucions() * 4) {
                                                if ((float) (xogador.getFortuna() - taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getValorinicial() * 0.6) > 0) {
                                                    //Construcción
                                                    taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).construirCasa();
                                                    //Contadores
                                                    xogador.getAvatar().getPosicion().setCasas(taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getCasas() + 1);
                                                    xogador.getAvatar().getPosicion().getGrupo().setCasas(taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getCasas() + 1);
                                                    //System.out.println(taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getCasas());

                                                    //Cobramos
                                                    xogador.setFortuna((float) (xogador.getFortuna() - taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getValorinicial() * 0.6));
                                                    xogador.setCartosInvertidos((float) (taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getValorinicial() * 0.6));

                                                    //describirmos la casilla
                                                    System.out.println(xogador.getAvatar().getPosicion().imprimirCasilla());
                                                } else {
                                                    System.out.println("O xogador non ten fortuna suficiente.");
                                                }
                                            } else {
                                                System.out.println("Non podes construir máis casas neste grupo.");
                                            }
                                        } else {
                                            System.out.println("Non podes constinuar construindo casas neste grupo.");
                                        }
                                        //System.out.println(taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getCasas());
                                    } else {
                                        System.out.println("Non pode construir máis casas nesta casilla, debe construir un hotel\n");
                                    }

                                    break;
                                case "hotel":
                                    if (taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getCasas() > 3) //COmprobamso que teña catro casas
                                    {
                                        if (taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getMaxconstrucions() > taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getHoteis())//Comprobamos que se xa ten o máximo de hoteis e casas non poda construir máis casas
                                        {
                                            if ((float) (xogador.getFortuna() - taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getValorinicial() * 0.6) > 0) {
                                                taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).destruirCasa(4);
                                                //taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).setCasas(taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getCasas() - 4);
                                                //xogador.getAvatar().getPosicion().getGrupo().setCasas(xogador.getAvatar().getPosicion().getGrupo().getCasas() - 4);

                                                //Taboleiro
                                                taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).construirHotel();
                                                //Contadores
                                                xogador.getAvatar().getPosicion().setCasas(taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getCasas() - 4);
                                                xogador.getAvatar().getPosicion().setHoteis(taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getHoteis() + 1);
                                                xogador.getAvatar().getPosicion().getGrupo().setHoteis(taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getHoteis() + 1);
                                            ...
                                            System.out.println("Non podes constinuar construindo hoteis neste grupo.");
                                        }
                                    } else {
                                        System.out.println("Non tes suficientes casas.");
                                    }

                                    break;
                                case "piscina":
                                    if (taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getHoteis() > 0) //COmprobamso que teña catro casas
                                    {
                                        if (taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getMaxconstrucions() > taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getPiscinas())//Comprobamos que se xa ten o máximo de hoteis e casas non poda construir máis casas
                                        {
                                            if (taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getCasas() > 1) {
                                                if ((float) (xogador.getFortuna() - taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getValorinicial() * 0.4) > 0) {
                                                    //Taboleiro
                                                    taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).construirPiscina();
                                                    //Contadores
                                                    xogador.getAvatar().getPosicion().setPiscinas(taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getPiscinas() + 1);
                                                    xogador.getAvatar().getPosicion().getGrupo().setPistas(taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getPistas() + 1);

                                                    //Cobramos
                                                    xogador.setFortuna((float) (xogador.getFortuna() - taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getValorinicial() * 0.4));
                                                    xogador.setCartosInvertidos((float) (taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getValorinicial() * 0.4));
                                                ...
                                                System.out.println("Debes ter construido cando menos un hotel e dúas casas.");
                                            }
                                        } else {
                                            System.out.println("Alcanzaches o máximo do grupo");
                                        }
                                    ...
                                    break;
                                case "pista":
                                    if (taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getHoteis() > 1) //COmprobamso que teña catro casas
                                    {
                                        if (taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getMaxconstrucions() > taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getPistas())//Comprobamos que se xa ten o máximo de hoteis e casas non poda construir máis casas
                                        {
                                            if ((float) (xogador.getFortuna() - taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getValorinicial() * 1.25) > 0) {
                                                //Taboleiro
                                                taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).construirPistaDeDeporte();
                                                //Contadores
                                                xogador.getAvatar().getPosicion().setPistas(taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getPistas() + 1);
                                                xogador.getAvatar().getPosicion().getGrupo().setPistas(taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getGrupo().getPistas() + 1);

                                                //Cobramos
                                                xogador.setFortuna((float) (xogador.getFortuna() - taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getValorinicial() * 1.25));
                                                xogador.setCartosInvertidos((float) (taboleiro.getCasilla(xogador.getAvatar().getPosicion().getPosicion()).getValorinicial() * 1.25));
                                        ...
                                        System.out.println("Debes ter construidos dous hoteis.");
                                    }
                                    break;
                                default:
                                    System.out.println("\nComando edificar incorrecto.\n");
                                    break;
                            }
                        } else {
                            System.out.println("\nSó se pode edificar en casillas da túa propiedade.\n");
                        }
                    } else {
                        System.out.println("\nNon se pode edificar nunha casilla que non sexa de tipo Solar.\n");
                    }
                    break;
